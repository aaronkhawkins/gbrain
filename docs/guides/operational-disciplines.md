...
For X bookmark research, BirdClaw is only the collector; native creator-pack dream phases perform extraction and concept synthesis. See [BirdClaw Bookmarks in the Native Dream Cycle](birdclaw-native-dream.md) for the eligibility contract and [Isolated Research-Wiki Pilot](isolated-research-pilot.md) for the two-pass scheduled-path test and mandatory quality gate before cleanup or backlog release.
